...
if not os.path.exists("../data/testset"):
   os.makedirs("../data/testset")

dataset.to_csv(f'../data/testset/testdata_1min.csv', index=False)
...
dataset.to_csv(f'../data/testset/testdata.csv', index=False)
